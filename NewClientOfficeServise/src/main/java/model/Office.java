...
import javax.ws.rs.Path;
	...
	public class Office {
		...
		//insert 
		public String inserOfficedata(String OfficeID, String OfficeName, String OfficeType, String Address, String phone, String manager) {
			String output = "";
			...
			try {
				...
				con.close();
				String newClientDB = readOficeData();
		...
		public String readOficeData()
		{
			...
			try
			{
				...
				while (rs.next())
				{
					...
					+"<td><input name='btnRemove' type='button' value='Remove' class='btnRemove btn btn-danger' data-Office='"+ID+"'></td></tr>";
		...
		//Update
		//= " insert into newClientDB (`ID`,`OfficeID`,`OfficeName`,`OfficeType`,`Address`,`phone`,`manager`)"
		public String updateOffcieData(String ID, String OfficeID, String OfficeName, String OfficeType, String Address, String phone, String manager)
		{
			String output = "";
		...
		//Delete
		public String deleteOffcie(String ID)
		{
			String output = "";
